...
<%javascript%>
    ...
    js_col_name_json = [{
        ...
        "label": "<%$this->lang->line('SYSTEMEMAILS_EMAIL_TITLE')%>"
    },
    {
        "name": "mse_email_code",
        "label": "<%$this->lang->line('SYSTEMEMAILS_EMAIL_CODE')%>"
    },
    {
        "name": "mse_from_name",
        "label": "<%$this->lang->line('SYSTEMEMAILS_FROM_NAME')%>"
    },
    {
        "name": "mse_status",
        "label": "<%$this->lang->line('SYSTEMEMAILS_STATUS')%>"
    }];
