    ...
    <div class="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            ...
            <div id="scrollable_content" class="scrollable-content top-block-spacing ">
                <!-- Module View Block -->
                <div id="systememails" class="frm-view-block frm-stand-view">
                            ...
                            <div class="box gradient <%$rl_theme_arr['frm_stand_content_row']%> <%$rl_theme_arr['frm_stand_border_view']%>">
                                ...
                                <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                    ...
                                    <div class="form-row row-fluid" id="cc_sh_mse_bcc_email">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$data['mse_bcc_email']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mse_cc_email">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$data['mse_cc_email']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mse_email_format">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$data['mse_email_format']%></strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row row-fluid" id="cc_sh_mse_email_message">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$data['mse_email_message']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mse_email_footer">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$data['mse_email_footer']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mse_status">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$this->general->displayKeyValueData($data['mse_status'], $opt_arr['mse_status'])%></strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
