...
class Systememails_model extends CI_Model
{
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "mse_email_format" => array(
                "name" => "mse_email_format",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "eEmailFormat",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "type" => "textbox",
                "label" => "Email Format",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_EMAIL_FORMAT')
            ),
            ...
            "mse_email_footer" => array(
                "name" => "mse_email_footer",
                "table_name" => "mod_system_email",
                "table_alias" => "mse",
                "field_name" => "vEmailFooter",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "type" => "textbox",
                "label" => "Email Footer",
                "label_lang" => $this->lang->line('SYSTEMEMAILS_EMAIL_FOOTER')
            ),
            "mse_status" => array(
                "name" => "mse_status",
                "table_name" => "mod_system_email",
