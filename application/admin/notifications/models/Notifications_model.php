...
class Notifications_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->grid_fields = array("men_subject", "men_receiver", "men_t_send_date_time", "men_content", "men_notification_type", "ma_name", "men_status");
        $this->join_tables = array(
            array(
                "table_name" => "mod_admin",
                "table_alias" => "ma",
                "field_name" => "iAdminId",
                "rel_table_name" => "mod_executed_notifications",
                "rel_table_alias" => "men",
                "rel_field_name" => "iEntityId",
                "join_type" => "left",
                "extra_condition" => ""
            )
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $list = false)
    {
        if (is_array($fields)) {
            ...
            $this->db->select("men.dtSendDateTime AS men_t_send_date_time");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "men_subject" => array(
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getMySQLDefaultValue("men_subject", "MySQL", "NULL")
            ),
            "men_receiver" => array(
                "name" => "men_receiver",
                "table_name" => "mod_executed_notifications",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getMySQLDefaultValue("men_receiver", "MySQL", "NULL")
            ),
            "men_t_send_date_time" => array(
                "name" => "men_t_send_date_time",
                "table_name" => "mod_executed_notifications",
                "table_alias" => "men",
                "field_name" => "dtSendDateTime",
                "source_field" => "men_t_send_date_time",
            ...
            "men_content" => array(
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getMySQLDefaultValue("men_content", "MySQL", "NULL"),
            ...
            "men_notification_type" => array(
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getMySQLDefaultValue("men_notification_type", "Text", "EmailNotify")
            ),
            "ma_name" => array(
                "name" => "ma_name",
                "table_name" => "mod_admin",
                "table_alias" => "ma",
                "field_name" => "vName",
                "source_field" => "men_entity_id",
                "display_query" => "ma.vName",
                "entry_type" => "Table",
                "show_in" => "Both",
                "type" => "dropdown",
                "label" => "Receiver Name",
                "label_lang" => $this->lang->line('NOTIFICATIONS_RECEIVER_NAME'),
                "width" => 50,
                "search" => "Yes",
                "sortable" => "Yes",
                "addable" => "No",
                ...
                "related" => "Yes",
                "hidden" => "Yes",
                "default" => $this->filter->getMySQLDefaultValue("men_entity_id", "Text", "0")
            ),
            "men_status" => array(
                "name" => "men_status",
                "table_name" => "mod_executed_notifications",
                ...
                "viewedit" => "No",
                "hidden" => "Yes",
                "default" => $this->filter->getMySQLDefaultValue("men_status", "Text", "Executed")
            )
        );
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "men_group_id" => array(
                ...
                "type" => "dropdown",
                "label" => "Group Name",
                "label_lang" => $this->lang->line('NOTIFICATIONS_GROUP_NAME')
            ),
            "men_entity_type" => array(
                ...
                "default" => $this->filter->getMySQLDefaultValue("men_entity_type", "Text", "Admin")
            ),
    ...
    /**
     * getNotificationContent method is used to fetch notification content.
     * @param numeric $id id is to get specific notification content.
     * @return array $data_arr returns data records array.
     */
    public function getNotificationContent($id = '')
    {
        $this->db->select("tContent,vSubject");
        $this->db->where('iExecutedNotificationId', $id);
