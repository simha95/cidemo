    ...
    <div class="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            ...
            <div id="scrollable_content" class="scrollable-content top-block-spacing ">
                <!-- Module View Block -->
                <div id="loghistory" class="frm-view-block frm-stand-view">
                                ...
                                <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                    <div class="form-row row-fluid" id="cc_sh_mlh_user_id">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$this->general->displayKeyValueData($data['mlh_user_id'], $opt_arr['mlh_user_id'])%></strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row row-fluid" id="cc_sh_mlh_user_type">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$this->general->displayKeyValueData($data['mlh_user_type'], $opt_arr['mlh_user_type'])%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mlh_current_url">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$data['mlh_current_url']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mlh_extra_param">
                                        ...
                                        <div class="form-right-div frm-elements-div  ">
                                            <strong><%$data['mlh_extra_param']%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mlh_login_date">
                                        ...
                                        <div class="form-right-div frm-elements-div  input-append text-append-prepend  ">
                                            <strong><%$this->general->dateTimeSystemFormat($data['mlh_login_date'])%></strong>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid" id="cc_sh_mlh_logout_date">
                                        ...
                                        <div class="form-right-div frm-elements-div  input-append text-append-prepend  ">
                                            <strong><%$this->general->dateTimeSystemFormat($data['mlh_logout_date'])%></strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
