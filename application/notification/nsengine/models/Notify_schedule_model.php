...
/**
 * Description of NS Engine Schedule Model
 *
 ...
 * @module NS Engine
 * 
 * @class Notify_schedule_model.php
 * 
 * @path application\front\nsengine\models\Notify_schedule_model.php
 *
 * @version 4.0
 * 
 * @author CIT Dev Team
 ...
 * @since 01.08.2016
 */
class Notify_schedule_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->main_table = "mod_notify_schedule";
        $this->table_alias = "mns";
        $this->primary_key = "iNotifyScheduleId";
    }
